...
#define KB_KEY_NUMPAD_PLUS  	0x4e
#define KB_KEY_NUMPAD_MINUS 	0x4a
#define KB_KEY_NUMPAD_ENTER  	0x9c
#define KB_KEY_NUMPAD_MUL    	0x37
#define KB_KEY_NUMPAD_DIV	  	0xb5
#define KB_KEY_NUMPAD_INS	  	0x52
#define KB_KEY_NUMPAD_SUPPR	  	0x53
